...
const SellerRequest = () => {
    ...
    const { sellers, totalSeller, loader, errorMessage } = useSelector(state => {
        console.log('State:', state); // Add this line to log the state
        return state.seller || {}; // Add default value to avoid destructuring errors
    });
