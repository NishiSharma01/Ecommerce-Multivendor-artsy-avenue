...
const Category = () => {
    ...
    return (
        ...
        <div className='flex lg:hidden justify-between items-center mb-5 p-4 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 rounded-md'>
            <h1 className='text-[#d0d2d6] font-semibold text-lg'>Category</h1>
            <button onClick={() => setShow(true)} className='bg-blue-600 shadow-lg hover:shadow-blue-500/40 px-4 py-2 cursor-pointer text-white rounded-sm text-sm'>Add</button>
            ...
            <div className='flex flex-wrap w-full'>
                ...
                <div className='w-full p-4 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 rounded-md'>
   ...
   <div className='relative overflow-x-auto'>
    ...
    <div className='w-full pl-5'>
        <div className='bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 h-screen lg:h-auto px-3 py-2 lg:rounded-md text-[#d0d2d6]'>
            ...
            <div className='mt-4'>
            <button disabled={loader ? true : false}  className='bg-blue-700 w-full hover:shadow-blue-700/50 hover:shadow-lg text-white rounded-md px-7 py-2 mb-3'>
            {
