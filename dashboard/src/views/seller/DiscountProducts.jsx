        ...
        <tbody>

            {
                ...
                <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>
                    ...
                    <img className='w-[45px] h-[45px]' src={`http://localhost:3000/images/category/${d}.png`} alt="" />

                </td>

                <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>Abstract Painitng</td>

                <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>Abstract Art</td>

                <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>Veirdo </td>

                <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>$132</td>
