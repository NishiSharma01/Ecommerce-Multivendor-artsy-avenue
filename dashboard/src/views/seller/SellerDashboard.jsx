    ...
    return (
        ...
        <div className='w-full flex flex-wrap mt-7'>
            <div className='w-full lg:w-7/12 lg:pr-3'>
                <div className='w-full bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 p-4 rounded-md'>
        ...
        <div className='w-full lg:w-5/12 lg:pl-4 mt-6 lg:mt-0'>
            <div className='w-full bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 p-4 rounded-md text-[#d0d2d6]'>
        ...
        <div className='w-full p-4 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 rounded-md mt-6'>
            <div className='flex justify-between items-center'>
