  ...
  const {userInfo } = useSelector(state => state.auth)
    ...
    return (
        <div className='fixed top-0 left-0 w-full py-5 px-2 lg:px-7 z-40'>
          <div className='ml-0 lg:ml-[260px] rounded-md h-[65px] flex justify-between items-center bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 px-5 transition-all'>
        ...
        <div className='flex justify-center items-center gap-8 relative'>
          ...
          <span className='text-[14px] w-full font-normal'>{ userInfo.role }</span>
              ...
              {
                userInfo.role === 'admin' ? <img className='w-[45px] h-[45px] rounded-full overflow-hidden' src="http://localhost:3001/images/admin copy.png" alt="" />  : <img className='w-[45px] h-[45px] rounded-full overflow-hidden' src={userInfo.image} alt="" />
              }
