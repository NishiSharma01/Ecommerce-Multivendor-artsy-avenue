...
const Card = () => {
   ...
   <div className='flex justify-between w-5/12 sm:w-full sm:mt-3'>
       ...
       <div className='flex gap-2 flex-col'>
           ...
           <button onClick={() => dispatch(delete_card_product(p._id)) }  className='px-5 py-[3px] bg-red-500 text-white'>Remove</button>
       </div>
   </div>
    ...
    <div className='pl-3 md-lg:pl-0 md-lg:mt-5'>
        {
            card_products.length > 0 && <div className='bg-white p-3 text-slate-600 flex flex-col gap-3'>
                ...
                <input className='w-full px-3 py-2 border border-slate-200 outline-0 focus:border-green-500 rounded-sm' type="text" placeholder='Input Coupon/Voucher Code' />
