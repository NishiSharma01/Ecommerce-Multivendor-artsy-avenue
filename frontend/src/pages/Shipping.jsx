...
const Shipping = () => {
    ...
    return (
        <div>
          <Header/>
          <section className='bg-[url("http://localhost:3000/images/banner/Designer.png")] h-[220px] mt-6 bg-cover bg-no-repeat relative bg-left'>
        ...
        <div className='w-[85%] lg:w-[90%] md:w-[90%] sm:w-[90%] mx-auto py-16'>
           <div className='w-full flex flex-wrap'>
            ...
            <div className='flex flex-col gap-1 mb-2 w-full'>
                ...
                <input onChange={inputHandle} value={state.post} type="text" className='w-full px-3 py-2 border border-slate-200 outline-none focus:border-green-500 rounded-md' name="post" id="post" placeholder='Postal Code' /> 
            </div> 
            </div>
            ...
            <div className='flex flex-col gap-1 mb-2 w-full'>
                ...
                <input onChange={inputHandle} value={state.province} type="text" className='w-full px-3 py-2 border border-slate-200 outline-none focus:border-green-500 rounded-md' name="province" id="State" placeholder='Province' /> 
            </div>
            ...
            <div className='flex flex-col gap-1 mb-2 w-full'>
                ...
                <input onChange={inputHandle} value={state.area} type="text" className='w-full px-3 py-2 border border-slate-200 outline-none focus:border-green-500 rounded-md' name="area" id="area" placeholder='country' /> 
            </div>
...

            {
                ...
                <p className='text-slate-600 text-sm' >Email To nishi050772@gmail.com</p>
