        ...
        <footer className='bg-[#f3f6fa]'>
            <div className='w-[85%] flex flex-wrap mx-auto border-b py-16 md-lg:pb-10 sm:pb-6'>
                <div className='w-3/12 lg:w-4/12 sm:w-full'>
                    <div className='flex flex-col gap-3'>
                        <img className='w-[190px] h-[70px]' src="http://localhost:3000/images/logo-no-background.png"  alt="logo" className='w-15 h-auto'/>
                        <ul className='flex flex-col gap-2 text-slate-600'>
                            <li>Address :  2514 Ivins Avenue, Egg Harbor Township, NJ 08234,</li>
                            <li>Phone : 4343434344</li>
                            <li>Email : support@artsyavenue.com</li>
                        </ul> 
                    </div> 
                </div>
            ...
            <div className='w-4/12 lg:w-full lg:mt-6'>
                <div className='w-full flex flex-col justify-start gap-5'>
                    ...
                    <span>Get Email updates about tour latest and shop special offers</span>
