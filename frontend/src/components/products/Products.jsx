...
const Products = ({title,products}) => {
    ...
    const ButtonGroup = ({next,previous}) => {
        return (
            <div className='flex justify-between  items-center bg-green-400'>
                ...
                <div className='flex justify-center items-center gap-3 text-slate-600 bg-gradient-to-r from-blue-200 to-cyan-200'>
    ...
    return (
                ...
                >
       {
        products.map((p,i)=> {
            return(
                <div key={i}className='flex flex-col bg-gradient-to-t from-green-300 via-transparent to-orange-300 justify-start gap-1'>
               {
