...
const FeatureProducts = ({products}) => {
    ...
    return ( 
        <div className='w-[95%] flex flex-wrap mx-auto'>
            ...
            <div className='text-center flex justify-center bg-gradient-to-t from-green-300 via-transparent to-orange-300 items-center flex-col text-4xl text-slate-600 font-bold relative pb-[45px]'>
                <h2>Feature Products </h2>
                <div className='w-[100px] h-[2px] bg-[#059473] mt-4'></div>
            </div>
            </div>

        <div className='w-full grid bg-gradient-to-t from-green-300 via-transparent to-orange-300 grid-cols-4 md-lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-6'>
    {
