...
const Header = () => {
    ...
    return (
        <div className='w-full  bg-gradient-to-t from-green-300 via-transparent to-orange-300'>
            <div className='header-top bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90%  md-lg:hidden'>
                <div className='w-[85%] lg:w-[90%] mx-auto'>
                    <div className='flex w-full justify-between items-center h-[50px] text-white-500'>
        ...
        <div className='flex group cursor-pointer text-white-800 text-sm justify-center items-center gap-1 relative after:h-[18px] after:w-[1px] after:bg-[#afafaf] after:-right-[16px] after:absolute before:absolute before:h-[18px] before:bg-[#afafaf] before:w-[1px] before:-left-[20px]'>
        ...
        {
            userInfo? <Link className='flex cursor-pointer justify-center items-center gap-2 text-sm text-white' to='/dashboard'>
                <span> <FaUser/> </span>
                <span>{userInfo.name} </span>
                 </Link> : <Link to='/login' className='flex cursor-pointer justify-center items-center gap-2 text-sm text-white'>
                <span> <FaLock /> </span>
                <span>Login </span>
                 </Link>
        }
         ...
         <div className='w-[85%] lg:w-[90%] mx-auto'>
            ...
            <div className='flex justify-between items-center'>
                <Link to='/'>
                    <img src="http://localhost:3000/images/logo-no-background.png" alt="" />
                </Link>
                ...
                <div className='flex justify-between md-lg:justify-center items-center flex-wrap pl-8'>
                    ...
                    < div className='flex justify-center gap-5'>
                        <Link to='/dashboard/my-wishlist'className='relative flex justify-center items-center cursor-pointer w-[35px] h-[35px] rounded-full bg-[#e2e2e2]'>
...
<div className='hidden md-lg:block'>
    ...
    <div className='w-[85%] lg:w-[90%] mx-auto py-5'>
        < div className='flex w-full flex-wrap md-lg:gap-8'>
            <div className='w-3/12 md-lg:w-full'>
                <div className='bg-white relative'>
                   <div onClick={() => setCategoryShow(!categoryShow) } className='h-[50px] bg-gradient-to-r from-cyan-500 to-blue-500  text-white flex justify-center md-lg:justify-between md-lg:px-6 items-center gap-3 font-bold text-md cursor-pointer'>
        ...
        <div className={`${categoryShow ? 'h-0' : 'h-[400px]'} overflow-scroll transition-all md-lg:relative duration-500 absolute z-[99999] bg-[#b7dfee] w-full border-x`}>
            ...
            <div className='flex flex-wrap w-full justify-between items-center md-lg:gap-6'>
                <div className='w-8/12 md-lg:w-full'>
                    <div className='flex border h-[50px] items-center relative gap-6'>
                        ...
                        <button onClick={search}className='bg-gradient-to-r from-cyan-500 to-blue-500  right-0 absolute px-8 h-full font-semibold uppercase text-white'>Search</button>
                    </div> 
                </div>
